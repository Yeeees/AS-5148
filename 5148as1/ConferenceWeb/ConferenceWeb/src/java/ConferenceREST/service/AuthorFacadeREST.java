...
public class AuthorFacadeREST extends AbstractFacade<Author> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, Author entity) {
        super.edit(entity);
    }
    ...
    public Author find(@PathParam("id") BigDecimal id) {
