...
public class PaperFacadeREST extends AbstractFacade<Paper> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, Paper entity) {
        super.edit(entity);
    }
    ...
    public Paper find(@PathParam("id") BigDecimal id) {
