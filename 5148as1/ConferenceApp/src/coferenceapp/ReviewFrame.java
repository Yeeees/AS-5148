...
public class ReviewFrame extends javax.swing.JFrame {
 ...
 Statement stmt = null;
 ResultSet rset = null;
 Object columnHeaders[] = {"PC_MEMBER_ID", "PAPER_ID","REVIEW_DATE","RECOMMENDATION","DUE_DATE","COMMENT"};
 Object data[][] = {{}};
...
columnHeaders); 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PC_MEMBER_ID");

        jLabel2.setText("PAPER_ID");

        jLabel3.setText("REVIEW_DATE");
 ...
 System.out.println(f.getMessage());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       int pcid = Integer.parseInt(jTextField1.getText());
       int paperid = Integer.parseInt(jTextField2.getText());
       String reviewdate = jTextField3.getText();
       String  recommend= jTextField4.getText();
       String duedate = jTextField5.getText();
       String comment = jTextField6.getText();
...
rset = stmt.executeQuery(
                     "insert into review values('"+pcid+"','"+paperid+"','"+reviewdate+"','"+recommend+"','"+duedate+"','"+comment+"')");
...
System.out.println(f.getMessage());
 ...
 stmt = ConferenceApp.conn2.createStatement();
 rset = stmt.executeQuery(
                     "update review set review_date='"+reviewdate+"',recommendation='"+recommend+"',due_date='"+duedate+"',review_comment='"+comment+"' where pc_member_mem_id ="+ pcid +" and paper_paper_id="+paperid);
       ...
       int paperid = Integer.parseInt(jTextField2.getText());
              dtm.setRowCount(0);
               try {
                           stmt = ConferenceApp.conn2.createStatement();
                           rset = stmt.executeQuery(
                           "delete from review where pc_member_mem_id ="+ pcid +" and paper_paper_id="+paperid);
...
String search = jTextField4.getText();
        try {
                       stmt = ConferenceApp.conn2.createStatement();
                       rset = stmt.executeQuery
                       ("select * from review where recommendation = '" + search+"'");
