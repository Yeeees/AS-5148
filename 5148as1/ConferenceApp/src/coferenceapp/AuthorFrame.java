...
public class AuthorFrame extends javax.swing.JFrame {
 ...
 Statement stmt = null;
 ResultSet rset = null;
 Object columnHeaders[] = {"AUTHOR_ID", "AUTHOR_FNAME","AUTHOR_LNAME","AUTHOR_AFFILIATION","AUTHOR_COUNTRY","AUTHOR_EMAIL","AUTHOR_NUMBER"};
 Object data[][] = {{}};
...
columnHeaders); 
    ...
    private void initComponents() {
        ...
        jLabel2.setText("AUTHOR_FNAME");

        jLabel3.setText("AUTHOR_LNAME");

        jLabel4.setText("AUTHOR_AFFILIATION");

        jLabel5.setText("AUTHOR_COUNTRY");

        jLabel6.setText("AHTHOR_EMAIL");

        jLabel7.setText("AUTHOR_NUMBER");
 ...
 System.out.println(f.getMessage());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       String  affiliation= jTextField4.getText();
...
rset = stmt.executeQuery(
                     "insert into author values(author_id.nextval,'"+fname+"','"+lname+"','"+affiliation+"','"+country+"','"+email+"','"+number+"')");
...
stmt = ConferenceApp.conn2.createStatement();
rset = stmt.executeQuery(
                     "update author set author_fname='"+fname+"',author_lname='"+lname+"',author_affiliation='"+affiliation+"',author_country='"+country+"',"
                             + "author_email='"+email+"',author_number='"+number+"'where author_id="+authorid);
...
String search = jTextField5.getText();
        try {
                      stmt = ConferenceApp.conn2.createStatement();
                      rset = stmt.executeQuery
                       ("select * from author where author_country = '" + search+"'");
